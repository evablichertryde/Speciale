...
```{r}
png(file="../figures/forudsætningstest/model 2 uden kontrol/residualer.png", width = 7.5, height = 4, units = "in", res=500)
...
```{r}
png(file="../figures/forudsætningstest/model 2 uden kontrol/plotr.png", width = 7.5, height = 7.5, units = "in", res=500)
par(mfrow = c(2, 2))
plot(lm)
dev.off()
...
```{r}
png(file="../figures/forudsætningstest/model 2 uden kontrol/homoskedadastitet.png", width = 7.5, height = 7.5, units = "in", res=500)
...
```{r}
png(file="../figures/forudsætningstest/model 2 uden kontrol/normal fordeling.png", width = 7.5, height = 7.5, units = "in", res=500)
...
r
png(file="../figures/forudsætningstest/model 2 uden kontrol/Multicollinearity.png", width = 7.5, height = 5, units = "in", res=500)
plot(r)
dev.off()
...
```{r}
png(file="../figures/forudsætningstest/model 2 uden kontrol/outliers.png", width = 7.5, height = 5, units = "in", res=500)
check_outliers(lm)
...
```{r}
png(file="../figures/forudsætningstest/model 2 uden kontrol/check model.png", width = 7.5, height = 9, units = "in", res=500)
