...
```{r}
start.time <- Sys.time()
png(file="../figures/forudsætningstest/model 2 med kontrol/linaritet.png", width = 7.5, height = 7.5, units = "in", res=500)
...
```{r}
png(file="../figures/forudsætningstest/model 2 med kontrol/linearitet religion 2.png", width = 7.5, height = 4, units = "in", res=500)
avPlot(lm, variable = "rlgdgr")
dev.off()

png(file="../figures/forudsætningstest/model 2 med kontrol/linearitet indkomst 2.png", width = 7.5, height = 4, units = "in", res=500)
avPlot(lm, variable = "income")
dev.off()

png(file="../figures/forudsætningstest/model 2 med kontrol/linearitet alder 2.png", width = 7.5, height = 4, units = "in", res=500)
...
```{r}
png(file="../figures/forudsætningstest/model 2 med kontrol/residualer.png", width = 7.5, height = 4, units = "in", res=500)
...
```{r}
png(file="../figures/forudsætningstest/model 2 med kontrol/plotr.png", width = 7.5, height = 7.5, units = "in", res=500)
par(mfrow = c(2, 2))
plot(lm)
dev.off()
...
```{r}
png(file="../figures/forudsætningstest/model 2 med kontrol/homoskedadastitet.png", width = 7.5, height = 7.5, units = "in", res=500)
...
```{r}
png(file="../figures/forudsætningstest/model 2 med kontrol/normal fordeling.png", width = 7.5, height = 7.5, units = "in", res=500)
...
png(file="../figures/forudsætningstest/model 2 med kontrol/normal fordeling niveau.png", width = 7.5, height = 10, units = "in", res=500)
...
r
png(file="../figures/forudsætningstest/model 2 med kontrol/Multicollinearity.png", width = 7.5, height = 5, units = "in", res=500)
plot(r)
dev.off()
...
```{r}
png(file="../figures/forudsætningstest/model 2 med kontrol/outliers.png", width = 7.5, height = 5, units = "in", res=500)
check_outliers(lm)
...
```{r}
png(file="../figures/forudsætningstest/model 2 med kontrol/check model.png", width = 7.5, height = 9, units = "in", res=500)
